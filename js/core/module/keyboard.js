	...
	$.extend(true, Keyboard, Events, {
		...
		*/
		createKeys: function (layout) {
			var $line = null, $key = null, $keyContent = null, $inputWrapper = null, signElemSize = 0;
			if (!layout) layout = this.layouts[this.lang].layout;

			this.$el.html("");
			$inputWrapper = $("<div class='input-wrapper'></div>");
			$inputWrapper.append(this.input.$el);
		...
		*/
		showKeyboard: function () {
			if (this.keyboardPosition == this.enums["BOTTOM"]) this.$el.attr("style", "bottom: 100px");
